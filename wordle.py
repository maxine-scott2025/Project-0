...
for i in range(6):
  ...
  guess = input("Please enter a 5 letter word, in all caps please :).")
  ...
  if hint == "GGGGG":
    print("Congrats you've guessed the right word!")
    break
...
if hint != "GGGGG":
  print("You've used up all your guess and you haven't guessed the right word, the word was", word)